...
<head>
  ...
  <title>Contact | Express Cash</title>
    ...
    <div class="navigation-container">
      <div class="navigation-wrapper">
        ...
        <nav role="navigation" class="navigation-menu w-nav-menu">
          ...
          <a href="https://www.expresscash.ca/contact" aria-current="page" class="navigation-link w-nav-link w--current">Contact Us</a>
    ...
    <div class="form-container">
      <div class="form-wrap">
        <div class="title-wrap">
          <div class="form-icon-circle"><img src="images/messenger.png" loading="lazy" alt="Messenger icon"></div>
          <h2 class="form-heading">Thank you! Your submission has been received!</h2>
        </div>
      </div>
    </div>
  </div>
